...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_top_header = resolveComponent("top_header");
  const _component_router_view = resolveComponent("router-view");
  return openBlock(), createBlock(VApp, null, {
    default: withCtx(() => [
      createVNode(_component_top_header),
      createVNode(VContainer, null, {
        default: withCtx(() => [
          createVNode(VStepperHeader, null, {
            default: withCtx(() => [
              createTextVNode("AIGC主页面")
            ]),
            _: 1
          })
        ]),
      ...
      createVNode(VContainer, null, {
        default: withCtx(() => [
          createVNode(VStepperHeader, null, {
            default: withCtx(() => [
              createTextVNode("当前为控制中心")
            ]),
            _: 1
          }),
          createVNode(VCardText, null, {
            default: withCtx(() => [
              createTextVNode("当前为测试版")
            ]),
            _: 1
          })
        ]),
...
//# sourceMappingURL=center-B2AnijsL.js.map
