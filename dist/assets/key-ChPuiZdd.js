...
import Fastgpt from "./fastgpt-DWjGZAGu.js";
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  const _component_fastgpt = resolveComponent("fastgpt");
  return openBlock(), createElementBlock(Fragment, null, [
    ...
    createVNode(VTabs, {
      ...
      default: withCtx(() => [
        createVNode(VTab, null, {
          default: withCtx(() => [
            createTextVNode("FastGPT")
          ]),
          _: 1
        }),
        createVNode(VTab, null, {
          default: withCtx(() => [
            createTextVNode("QWen")
          ]),
          _: 1
        })
      ]),
    ...
    $data.tab === 1 ? (openBlock(), createBlock(_component_fastgpt, { key: 1 })) : createCommentVNode("", true)
  ], 64);
}
const key = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render]]);
export {
  key as default
};
