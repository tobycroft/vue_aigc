...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createBlock(VToolbar, {
    ...
    default: withCtx(() => [
      ...
      createVNode(VBtn, {
        onClick: _cache[3] || (_cache[3] = ($event) => $options.navigateTo("/v1/user"))
      }, {
        default: withCtx(() => [
          createTextVNode("我的")
        ]),
...
//# sourceMappingURL=topheader-wnJjQTuF.js.map
