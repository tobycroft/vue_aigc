...
export class Viewer {
    ...
    async loadVrm(url) {
        ...
        await this.model.loadVRM(url).then(async () => {
            ...
            // HACK: 銈€儖銉°兗銈枫儳銉炽伄鍘熺偣銇屻仛銈屻仸銇勩倠銇仹鍐嶇敓寰屻伀銈儭銉╀綅缃倰瑾挎暣銇欍倠
    ...
    /**
     * React銇х鐞嗐仐銇︺亜銈婥anvas銈掑緦銇嬨倝瑷畾銇欍倠
     */
    setup(canvas) {
    ...
    /**
     * canvas銇Κ瑕佺礌銈掑弬鐓с仐銇︺偟銈ゃ偤銈掑鏇淬仚銈�
     */
    resize() {
    ...
    /**
     * VRM銇甴ead銉庛兗銉夈倰鍙傜収銇椼仸銈儭銉╀綅缃倰瑾挎暣銇欍倠
     */
    resetCamera() {
