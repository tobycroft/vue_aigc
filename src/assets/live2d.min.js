!(function (t) {
    ...
    g.STATE_FIRST = 'STATE_FIRST', g.STATE_INTERVAL = 'STATE_INTERVAL', g.STATE_CLOSING = 'STATE_CLOSING', g.STATE_CLOSED = 'STATE_CLOSED', g.STATE_OPENING = 'STATE_OPENING', _.mul = function (t, i, e) {
        ...
        if (t != null) for (var i = 0; i < this.partsGroups.length; i++) for (var e = this.partsGroups[i], r = 0; r < e.length; r++) {
            e[r].initIndex(t);
        ...
        for (var e = 0; e < i.length; e++) {
            var r = i[e];
            if (r.link != null && !(r.partsIndex < 0)) for (var o = t.getPartsOpacity(r.partsIndex), n = 0; n < r.link.length; n++) {
                var s = r.link[n];
    ...
    function n(t) {
        ...
        var r = e / i;
        var o = w.default.VIEW_LOGICAL_LEFT;
        var n = w.default.VIEW_LOGICAL_RIGHT;
        var _ = -r;
        var h = r;
    ...
    function u(t) {
        ...
        var o = $({x: i.left + i.width / 2, y: i.top + i.height * X}, {x: t.clientX, y: t.clientY}, i);
        var n = m(o.x - i.left);
        var s = T(o.y - i.top);
    ...
    function g(t) {
        if (t.type == 'mousewheel') ; else if (t.type == 'mousedown') p(t); else if (t.type == 'mousemove') {
            var i = sessionStorage.getItem('Sleepy');
            i === '1' && sessionStorage.setItem('Sleepy', '0'), u(t)
    ...
    (function (t) {
        !(function () {
            ...
            i._$0s = 1, i._$4s = 2, i._$42 = 0, i._$62 = function (t, e) {
                ...
                var s = 1 - (1 - o) * (1 - o);
                var _ = 1 - (1 - n) * (1 - n);
                var a = 1 / 3 * (1 - o) * s + (n * (2 / 3) + 1 / 3 * (1 - n)) * (1 - s);
                var h = (n + 2 / 3 * (1 - n)) * _ + (o * (1 / 3) + 2 / 3 * (1 - o)) * (1 - _);
                var l = 1 - 3 * h + 3 * a - 0;
                var $ = 3 * h - 6 * a + 0;
                var u = 3 * a - 0;
                if (r <= 0) return 0;
                ...
                if (i._$AT && !i._$9L) {
                    ...
                    var o = this._$V0;
                    o = o * (this._$dP == 0 ? 1 : ht._$r2((e - i._$bs) / this._$dP)) * (this._$eo == 0 || i._$Do < 0 ? 1 : ht._$r2((i._$Do - e) / this._$eo)), o >= 0 && o <= 1 || console.log('### assert!! ### '), this.updateParamExe(t, e, o, i), i._$Do > 0 && i._$Do < e && (i._$9L = !0)
                }
                ...
                var r;
                var o;
                var n = -Math.atan2(this.p1.y - this.p2.y, this.p1.x - this.p2.x);
                var s = Math.cos(n);
                var _ = Math.sin(n);
            ...
            It._$ni = function (t, i, e, r, o, n, s, _, a) {
                ...
                var i = [];
                return t == null ? null : t.length == 0 ? null : /,/.test(t) ? i = t.id.split(',') : (i.push(t.id), i)
                ...
                for (var e, r, o = this._$Ob.length, n = t._$v2(), s = 0, _ = 0; _ < o; _++) {
                    ...
                    var p = -1;
                    var f = 0;
                    if (r < 1) ; else if (r == 1) l = u[0], l - U._$J < h && h < l + U._$J ? (p = 0, f = 0) : (p = 0, i[0] = !0); else if (l = u[0], h < l - U._$J) p = 0, i[0] = !0; else if (h < l + U._$J) p = 0; else {
                ...
                for (var o = 0; o < r; ++o) {
                    ...
                    if (n != '\n' && n != '\r') if (n != '#') if (n != '$') {
                        ...
                        var u = !1;
                        if (_ >= 0) for (_ == s + 4 && t[s + 1] == 'f' && t[s + 2] == 'p' && t[s + 3] == 's' && (u = !0), o = _ + 1; o < r && ((n = 255 & t[o]) != '\r' && n != '\n'); ++o) if (n != ',' && n != ' ' && n != '\t') {
                            var l = O._$LS(t, r, o, e);
            ...
            Y._$V2 = -1, Y._$W0 = -1, Y._$jr = !1, Y._$ZS = !0, Y._$tr = -1e6, Y._$lr = 1e6, Y._$is = 32, Y._$e = !1, Y.prototype.getDrawDataIndex = function (t) {
                for (var i = this._$aS.length - 1; i >= 0; --i) if (this._$aS[i] != null && this._$aS[i].getDrawDataID() == t) return i;
                return -1
                ...
                if (P != null) {
                    var S = P._$1s();
                    if (S != null) for (var v = S.length, s = 0; s < v; ++s) {
                        var L = S[s];
                ...
                for (var u = null, p = 0; p < r; ++p) {
                    ...
                    try {
                        ...
                        f._$2b(this, c);
                        var d;
                        var g = Math.floor(f._$zS(this, c) - o);
                        try {
                            d = this._$Vs[g]
                        } catch (t) {
            ...
            wt.STATE_FIRST = 'STATE_FIRST', wt.STATE_INTERVAL = 'STATE_INTERVAL', wt.STATE_CLOSING = 'STATE_CLOSING', wt.STATE_CLOSED = 'STATE_CLOSED', wt.STATE_OPENING = 'STATE_OPENING', X.prototype = new E(), X._$As = 32, X._$Gr = !1, X._$NT = null, X._$vS = null, X._$no = null, X._$9r = function (t) {
                ...
                if (this._$GS._$Ur(t)) {
                    ...
                    if (this._$GS._$zr(n, s, o), o <= 0) {
                        ...
                        var u = s[1];
                        var v = s[2];
                        var p = c._$fL + (d._$fL - c._$fL) * h;
                        var f = g._$fL + (y._$fL - g._$fL) * h;
                        var L = m._$fL + (T._$fL - m._$fL) * h;
                        ...
                        var b = this._$Y0[n[8]];
                        var F = this._$Y0[n[9]];
                        var C = this._$Y0[n[10]];
                        var N = this._$Y0[n[11]];
                        var B = this._$Y0[n[12]];
                        var U = this._$Y0[n[13]];
                        var G = this._$Y0[n[14]];
                        var Y = this._$Y0[n[15]];
                        var h = s[0];
                        var u = s[1];
                        var v = s[2];
                        var k = s[3];
                        ...
                        var M = D._$fL + (R._$fL - D._$fL) * h;
                        var V = b._$fL + (F._$fL - b._$fL) * h;
                        var X = C._$fL + (N._$fL - C._$fL) * h;
                        var H = B._$fL + (U._$fL - B._$fL) * h;
                        var W = G._$fL + (Y._$fL - G._$fL) * h;
                ...
                for (var _ = z._$To, a = z._$Po, h = 1, l = 0; l < 10; l++) {
                    ...
                    if (a[0] = r[0] - h * o[0], a[1] = r[1] - h * o[1], i._$nb(t, e, a, _, 1, 0, 2), _[0] -= s[0], _[1] -= s[1], _[0] != 0 || _[1] != 0) return _[0] = -_[0], _[0] = -_[0], n[0] = _[0], void (n[1] = _[1]);
                    h *= 0.1
                }
                ...
                for (var o = 0; o < r; ++o) {
                    ...
                    if (n != '\n' && n != '\r') if (n != '#') if (n != '$') {
                        ...
                        var f = !1;
                        if (a >= 0) for (a == _ + 4 && Q(t, _ + 1) == 'f' && Q(t, _ + 2) == 'p' && Q(t, _ + 3) == 's' && (f = !0), o = a + 1; o < r && ((n = Q(t, o)) != '\r' && n != '\n'); ++o) if (n != ',' && n != ' ' && n != '\t') {
                            var u = O._$LS(t, r, o, e);
                ...
                for (var o = i - r._$z2, n = o * this._$D0 / 1e3, s = 0 | n, _ = n - s, a = 0; a < this.motions.length; a++) {
                    ...
                    if (h._$RP == B._$hs) {
                        ...
                        var p;
                        var f = t.getParamIndex($);
                        var c = t.getModelContext();
                        var d = c.getParamMax(f);
                        var g = c.getParamMin(f);
                        var y = 0.4 * (d - g);
                        var m = c.getParamFloat(f);
                        var T = h._$I0[s >= l ? l - 1 : s];
                ...
                var _ = i;
                var a = _._$hr != null ? _._$hr : _._$Cr;
                ...
                for (var h, l, $, u = r * n, p = 0, f = 0, c = 0, d = 0, g = 0, y = 0, m = !1, T = o; T < u; T += n) {
                    ...
                    if (v = i[T], L = i[T + 1], P = v * _, S = L * a, P < 0 || S < 0 || _ <= P || a <= S) {
                        ...
                        if (!m) {
                            ...
                            var A = s[2 * (_ + a * M) + 1] - s[2 * (0 + 0 * M) + 1];
                            var I = s[2 * (_ + 0 * M)] - s[2 * (0 + a * M)];
                            var w = s[2 * (_ + 0 * M) + 1] - s[2 * (0 + a * M) + 1];
                            c = 0.5 * (E + I), d = 0.5 * (A + w), g = 0.5 * (E - I), y = 0.5 * (A - w), p -= 0.5 * (c + g), f -= 0.5 * (d + y)
                        }
                        if (v > -2 && v < 3 && L > -2 && L < 3) if (v <= 0) if (L <= 0) {
                            var x = s[2 * (0 + 0 * M)];
                            var O = s[2 * (0 + 0 * M) + 1];
                            var D = p - 2 * c;
                            var R = f - 2 * d;
                ...
                for (var _, a, h, l, $, u, p, f = i, c = this._$o, d = this._$A, g = o * s, y = f._$hr != null ? f._$hr : f._$Cr, m = n; m < g; m += s) at._$ts ? (_ = e[m], a = e[m + 1], _ < 0 ? _ = 0 : _ > 1 && (_ = 1), a < 0 ? a = 0 : a > 1 && (a = 1), _ *= c, a *= d, h = 0 | _, l = 0 | a, h > c - 1 && (h = c - 1), l > d - 1 && (l = d - 1), u = _ - h, p = a - l, $ = 2 * (h + l * (c + 1))) : (_ = e[m] * c, a = e[m + 1] * d, u = _ - (0 | _), p = a - (0 | a), $ = 2 * ((0 | _) + (0 | a) * (c + 1))), u + p < 1 ? (r[m] = y[$] * (1 - u - p) + y[$ + 2] * u + y[$ + 2 * (c + 1)] * p, r[m + 1] = y[$ + 1] * (1 - u - p) + y[$ + 3] * u + y[$ + 2 * (c + 1) + 1] * p) : (r[m] = y[$ + 2 * (c + 1) + 2] * (u - 1 + p) + y[$ + 2 * (c + 1)] * (1 - u) + y[$ + 2] * (1 - p), r[m + 1] = y[$ + 2 * (c + 1) + 3] * (u - 1 + p) + y[$ + 2 * (c + 1) + 1] * (1 - u) + y[$ + 3] * (1 - p))
            ...
            at._$yr = !1, at._$Zs = !1, at.L2D_NO_ERROR = 0, at._$i7 = 1e3, at._$9s = 1001, at._$es = 1100, at._$r7 = 2e3, at._$07 = 2001, at._$b7 = 2002, at._$H7 = 4e3, at.L2D_COLOR_BLEND_MODE_MULT = 0, at.L2D_COLOR_BLEND_MODE_ADD = 1, at.L2D_COLOR_BLEND_MODE_INTERPOLATE = 2, at._$6b = !0, at._$cT = 0, at.clippingMaskBufferSize = 256, at.glContext = new Array(), at.frameBuffers = new Array(), at.fTexture = new Array(), at.IGNORE_CLIP = !1, at.IGNORE_EXPAND = !1, at.EXPAND_W = 2, at.USE_ADJUST_TRANSLATION = !0, at.USE_CANVAS_TRANSFORM = !0, at.USE_CACHED_POLYGON_IMAGE = !1, at.DEBUG_DATA = {}, at.PROFILE_IOS_SPEED = {
                ...
                if (!(n < 0.01 && this.clipBufPre_clipContextMask == null)) {
                    ...
                    var d, g, y, m;
                    if (this.clipBufPre_clipContextMask != null) d = a.ONE, g = a.ONE_MINUS_SRC_ALPHA, y = a.ONE, m = a.ONE_MINUS_SRC_ALPHA; else switch (s) {
                        case $t._$ms:
            ...
            St.prototype._$bT = function () {
                ...
                try {
                    var o = new Array();
                    if (i == null) for (var r = 0; r < t; ++r) o[r] = this._$T.getUint8(this._$F++); else for (var r = 0; r < t; ++r) o[r] = i[r];
                    return String.fromCharCode.apply(null, o)
                } catch (t) {
                ...
                var i;
                var e = Et.USER_AGENT;
                var r = Et.SYSTEM_INFO = {userAgent: e};
    ...
    o.prototype = new n.L2DBaseModel(), o.prototype.load = function (t, i, e) {
                ...
                for (var i = 0; i < r.modelSetting.getTextureNum(); i++) {
                    ...
                    r.loadTexture(i, o, function () {
                        if (r.isTexLoaded) {
                            ...
                            r.live2DModel.saveParam(), r.preloadMotionGroup(h.default.MOTION_GROUP_IDLE), r.preloadMotionGroup(h.default.MOTION_GROUP_SLEEPY), r.mainMotionManager.stopAllMotions(), r.setUpdating(!1), r.setInitialized(!0), typeof e === 'function' && e()
                        }
                    })
                }
            })
        ...
        if (this.live2DModel == null) return void (h.default.DEBUG_LOG && console.error('Failed to update.'));
        ...
        if (r == null || r == '') return void (h.default.DEBUG_LOG && console.error('Failed to motion.'));
        ...
        if (r.setFadeIn(this.modelSetting.getMotionFadeIn(t, i)), r.setFadeOut(this.modelSetting.getMotionFadeOut(t, i)), h.default.DEBUG_LOG && console.log('Start motion : ' + o), this.modelSetting.getMotionSound(t, i) == null) this.mainMotionManager.startMotionPrio(r, e); else {
        ...
        return t == 'head' ? this.hitTestSimpleCustom(h.default.hit_areas_custom_head_x, h.default.hit_areas_custom_head_y, i, e) : t == 'body' && this.hitTestSimpleCustom(h.default.hit_areas_custom_body_x, h.default.hit_areas_custom_body_y, i, e)
    }
}, function (t, i, e) {
    'use strict';
